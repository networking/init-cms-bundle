...
var KTAuthI18nDemo = function() {
	...
	var translationStrings = {
		...
		"general-desc" : {
			...
			"Italian" : "Obtenga acceso ilimitado y gane dinero",
		...
		"sign-in-head-desc" : {
			...
			"Italian" : "¿No eres miembro todavía?",
		...
		"sign-in-forgot-password" : {
			...
			"Italian" : "Has olvidado tu contraseña ?",
		...
		"sign-up-hint" : {
			...
			"Italian" : "Utilice 8 o más caracteres con una combinación de letras, números y símbolos.",
		...
		"new-password-title" : {
			...
			"Italian" : "Configurar nueva contraseña",
		...
		"new-password-desc" : {
			...
			"Italian" : "¿Ya has restablecido la contraseña?",
		...
		"password-reset-desc" : {
			...
			"Italian" : "Ingrese su correo electrónico para restablecer su contraseña.",
		...
		"two-step-head-desc" : {
			...
			"Italian" : "¿No recibiste el código?",
		...
		"two-step-title" : {
			...
			"Italian" : "Verificación de dos pasos",
		...
		"two-step-deck" : {
			...
			"Italian" : "Ingresa el código de verificación que enviamos a",
		...
		"two-step-label" : {
			...
			"Italian" : "Escriba su código de seguridad de 6 dígitos",
