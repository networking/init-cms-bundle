...
class MenuItemAdmin extends BaseAdmin
{
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        ...
        $er = $this->getContainer()->get('doctrine_mongodb')->getRepository('NetworkingInitCmsBundle:MenuItem');
...
//            $formMapper->add('menu', 'hidden', array('data' => $root->getId()));
            ...
            $formMapper
                ...
                'networking_type_autocomplete',
                    array(
                        ...
                        'class' => $this->getContainer()->getParameter('networking_init_cms.admin.page.class'),
                        'required' => false,
                        'property' => 'AdminTitle',
     ...
     * @return bool
     */
    public function getByLocale(ProxyQuery $proxyQuery, $alias, $field, $value)
    {
