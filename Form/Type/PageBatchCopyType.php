...
class PageBatchCopyType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ->add('fromLocale', 'choice', array('label' => 'form.label_from_locale', 'choices' => $choices))
            ->add('toLocale', 'choice', array('label' => 'form.label_to_locale', 'choices' => $choices));
    }
    ...
    {
        $resolver
            ->setDefined(array('locales'))
            ->isRequired('locales')
        ;
        $resolver->setDefault('constraints', new Callback(array($this, 'validateChoices')));
