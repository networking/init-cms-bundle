...
@trigger_error(sprintf('The "%s" interface is deprecated since InitCms 4.1, use "%s"  instead.', PhpCacheInterface::class,  PageCacheInterface::class), E_USER_DEPRECATED);
