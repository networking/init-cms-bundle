...
class UserAdmin extends BaseUserAdmin
{
    ...
    public function setGoogleAuthEnabled(bool $googleAuthEnabled): void
    {
     ...
     * @return array
     */
    public function getSubNavLinks(): array
    {
        $pool = $this->getConfigurationPool();
        $groupAdmin = $pool->getAdminByAdminCode('sonata.user.admin.group');

        return [
            $this->getTranslator()->trans($this->getLabel()) => $this,
            $this->getTranslator()->trans($groupAdmin->getLabel(), [], $groupAdmin->getTranslationDomain()) => $groupAdmin,
        ];
    }
    ...
    protected function configureFormFields(FormMapper $form): void
    {
        ...
        if ($this->googleAuthEnabled && $this->hasSubject() && $user && $user instanceof BaseUser && $user->getTwoStepVerificationCode()) {
