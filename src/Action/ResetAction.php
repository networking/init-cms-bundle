...
final class ResetAction
{
    ...
    public function __invoke(Request $request, string $token): Response
    {
        ...
        $form = $this->formFactory->create(ResettingFormType::class, null, ['validation_groups' => ['ResetPassword',]]);
        $form->setData($user);
        ...
        return new Response($this->twig->render('@NetworkingInitCms/Admin/Security/Resetting/reset.html.twig', [
            'token' => $token,
