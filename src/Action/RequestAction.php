...
final class RequestAction
{
    ...
    public function __invoke(Request $request): Response
    {
        ...
        $form = $this->formFactory->create(ResetPasswordRequestFormType::class, null, ['validation_groups' => ['ResetPassword']]);
        ...
        return new Response($this->twig->render('@NetworkingInitCms/Admin/Security/Resetting/request.html.twig', [
