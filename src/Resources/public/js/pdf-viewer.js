...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = '/bundles/networkinginitcms/vendor/pdfjs/web/images/';
  PDFJS.workerSrc = '/bundles/networkinginitcms/vendor/pdfjs/build/pdf.worker.js';
  PDFJS.cMapUrl = '/bundles/networkinginitcms/vendor/pdfjs/web/cmaps/';
...
function getViewerConfiguration() {
  return {
    ...
    debuggerScriptPath: '/bundles/networkinginitcms/vendor/pdfjs/web/debugger.js',
